...
if((i < len)){
var k = (ks[i]);
var G__36152 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__36153 = (i + (1));
m = G__36152;
i = G__36153;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36035 = p.children;
return module$node_modules$react$index.Children.toArray(G__36035);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36040 = c;
var G__36040__$1 = (((G__36040 == null))?null:G__36040.prototype);
if((G__36040__$1 == null)){
return null;
} else {
return G__36040__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36042 = c;
var G__36042__$1 = (((G__36042 == null))?null:G__36042.prototype);
if((G__36042__$1 == null)){
return null;
} else {
return G__36042__$1.render;
}
})() == null)))));
});
...
var G__36053 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36053) : reagent.impl.component.as_element.call(null,G__36053));
};
...
var _STAR_current_component_STAR__orig_val__36054 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36055 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36055);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36054);
}});
...
var G__36059 = key;
var G__36059__$1 = (((G__36059 instanceof cljs.core.Keyword))?G__36059.fqn:null);
switch (G__36059__$1) {
...
var c = this;
var G__36062_36160 = goog.object.get(c,"cljsRatom");
if((G__36062_36160 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36062_36160);
}
...
var renders_36161 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_36162 = cljs.core.first(cljs.core.vals(renders_36161));
...
if((cljs.core.count(renders_36161) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36161))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36162)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36162], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__36117 = o;
var G__36118_36163 = G__36117;
var G__36121_36164 = cljs.core.name(k);
var G__36122_36165 = v;
goog.object.set(G__36118_36163,G__36121_36164,G__36122_36165);
...
var G__36127_36166 = cmp.prototype;
var G__36128_36167 = module$node_modules$react$index.Component.prototype;
var G__36129_36168 = methods$;
goog.object.extend(G__36127_36166,G__36128_36167,G__36129_36168);
...
var name = (function (){var G__36133 = fiber;
var G__36133__$1 = (((G__36133 == null))?null:G__36133.type);
if((G__36133__$1 == null)){
return null;
} else {
return G__36133__$1.displayName;
}
})();
var parent = (function (){var G__36134 = fiber;
if((G__36134 == null)){
return null;
} else {
return G__36134.return;
}
})();
var path = (function (){var G__36135 = parent;
var G__36135__$1 = (((G__36135 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36135) : reagent.impl.component.fiber_component_path.call(null,G__36135)));
if((G__36135__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36135__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__36137 = c;
if((G__36137 == null)){
return null;
} else {
return goog.object.get(G__36137,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36138._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__36140 = c;
if((G__36140 == null)){
return null;
} else {
return goog.object.get(G__36140,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__36142 = c;
if((G__36142 == null)){
return null;
} else {
return G__36142._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__36144 = instance;
if((G__36144 == null)){
return null;
} else {
return goog.object.get(G__36144,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__36145 = instance;
if((G__36145 == null)){
return null;
} else {
return G__36145._currentElement;
}
}
})();
var name = (function (){var G__36146 = elem;
var G__36146__$1 = (((G__36146 == null))?null:G__36146.type);
if((G__36146__$1 == null)){
return null;
} else {
return G__36146__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__36148 = elem;
if((G__36148 == null)){
return null;
} else {
return goog.object.get(G__36148,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36149._owner;
}
}
})();
var path = (function (){var G__36150 = owner;
var G__36150__$1 = (((G__36150 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36150) : reagent.impl.component.component_path.call(null,G__36150)));
if((G__36150__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36150__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36151 = c;
var G__36151__$1 = (((G__36151 == null))?null:G__36151.constructor);
if((G__36151__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36151__$1);
}
}
})();
